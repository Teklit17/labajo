...
export const translations = {
  en: {
    ...
    appName: 'LABAGO',
    heroSub: 'We come to you — at home or at work. You never need to move your car.',
    bookNow: 'BOOK NOW',
    packagesTitle: 'PACKAGES & PRICES',
    howTitle: 'HOW IT WORKS',
    steps: ['Choose package and time', 'Enter your address', 'We come to you', 'Pay on site — cash or card'],
    reviewsTitle: 'CUSTOMER REVIEWS',
    reviews: [
      { name: 'Anna K.', text: 'The car looks brand new! Super fast and smooth.' },
      { name: 'Erik L.', text: 'Right on time and very thorough. Highly recommended!' },
      { name: 'Sara M.', text: 'Fantastic service, took care of my car at work.' },
    ],
    contact: 'Contact: Matti',

    // Package names/descriptions (prices come from CountryContext)
    packages: [
      { id: 'quick', name: 'Quick Wash', desc: 'Exterior wash + Rinse & dry + Wheel clean + 20-30 min' },
      { id: 'standard', name: 'Standard', desc: 'Exterior wash + Interior vacuum + Dashboard wipe + Windows + 40-50 min' },
      { id: 'premium', name: 'Premium', desc: 'Full exterior + Deep interior clean + Wax & polish + Leather care + 60-90 min' },
      { id: 'subscription', name: 'Monthly Plan', desc: '4 standard washes/month + Priority booking + Flexible scheduling + Best value' },
    ],
    ...
    addressNotesLabel: 'Delivery notes (optional)',
    addressNotesPlaceholder: 'Entrance code, floor, parking info',
    ...
    cash: '💵 Cash',
    swish: '📱 Swish',
    payAfterServiceNote: 'Pay on site after the wash is done, in cash, by card on our physical card reader, or via Swish.',
    ...
    confirmedSub: 'See you there! You will receive an SMS reminder the day before.',
    ...
    yourPinNote: 'Save this code — you\'ll need it together with your phone number to view or manage your bookings later.',
    existingPinTitle: 'USE YOUR EXISTING PIN CODE',
    existingPinNote: 'This phone number already has a PIN code from a previous booking. Use that code together with your phone number to view or manage your bookings. Lost it? Contact us and we\'ll help you.',
    editBooking: 'EDIT',
    cancelBooking: 'CANCEL',
    bookingCancelled: 'This booking has been cancelled.',
    cancelBookingTitle: 'Cancel booking?',
    cancelBookingMsg: 'Are you sure you want to cancel this booking? This cannot be undone.',
    ...
    whyTitle: 'WHY LABAGO',
    whyItems: [
      { icon: '🚗', title: 'We come to you', sub: 'No driving, no waiting rooms.' },
      { icon: '⏱', title: 'Fast service', sub: '1–4 hours depending on package.' },
      ...
      { icon: '🕗', title: 'Working hours', sub: 'Mon–Fri 08:00–18:00 · Sat–Sun 09:00–18:00.' },
    ],

    // CTA banner
    ctaBannerTitle: 'Ready for a clean car?',
    ctaBannerSub: 'Book in under 2 minutes.',
    ...
    areaExpandText: 'We currently provide our services in these areas and nearby locations. We are also planning to expand to more cities in the future.',
  ...
  sv: {
    ...
    appName: 'LABAGO',
    heroSub: 'Vi kommer till dig — hemma eller på jobbet. Du behöver inte flytta bilen.',
    bookNow: 'BOKA NU',
    packagesTitle: 'PAKET & PRISER',
    howTitle: 'SÅ HÄR FUNGERAR DET',
    steps: ['Välj paket och tid', 'Ange din adress', 'Vi kommer till dig', 'Betala på plats — kontant eller kort'],
    reviewsTitle: 'KUNDRECENSIONER',
    reviews: [
      { name: 'Anna K.', text: 'Bilen ser ut som ny! Supersnabb och smidig.' },
      { name: 'Erik L.', text: 'Kom precis i tid och jobbade noggrant. Rekommenderas!' },
      { name: 'Sara M.', text: 'Fantastisk service, tog hand om min bil på jobbet.' },
    ],
    contact: 'Kontakt: Matti',

    packages: [
      { id: 'quick', name: 'Quick Wash', desc: 'Exteriörtvätt + Sköljning & torkning + Fälgtvätt + 20-30 min' },
      { id: 'standard', name: 'Standard', desc: 'Exteriörtvätt + Dammsugning inuti + Torka instrumentpanel + Fönster + 40-50 min' },
      { id: 'premium', name: 'Premium', desc: 'Full exteriör + Djuprengöring inuti + Vax & polish + Lädervård + 60-90 min' },
      { id: 'subscription', name: 'Månadsabonnemang', desc: '4 standardtvättar/månad + Prioriterad bokning + Flexibel schemaläggning + Bäst värde' },
    ],
    ...
    addressNotesLabel: 'Leveransanteckningar (valfritt)',
    addressNotesPlaceholder: 'Portkod, våning, parkering',
    ...
    cash: '💵 Kontant',
    swish: '📱 Swish',
    payAfterServiceNote: 'Betala på plats när tvätten är klar, kontant, med kort i vår fysiska kortterminal, eller via Swish.',
    ...
    yourPinNote: 'Spara den här koden — du behöver den tillsammans med ditt telefonnummer för att se eller hantera dina bokningar senare.',
    existingPinTitle: 'ANVÄND DIN BEFINTLIGA PIN-KOD',
    existingPinNote: 'Det här telefonnumret har redan en PIN-kod från en tidigare bokning. Använd den koden tillsammans med ditt telefonnummer för att se eller hantera dina bokningar. Tappat bort den? Kontakta oss så hjälper vi dig.',
    editBooking: 'ÄNDRA',
    cancelBooking: 'AVBOKA',
    bookingCancelled: 'Den här bokningen har avbokats.',
    cancelBookingTitle: 'Avboka bokning?',
    cancelBookingMsg: 'Är du säker på att du vill avboka? Detta kan inte ångras.',
    ...
    whyItems: [
      { icon: '🚗', title: 'Vi kommer till dig', sub: 'Ingen körning, inga vänterum.' },
      { icon: '⏱', title: 'Snabb service', sub: '1–4 timmar beroende på paket.' },
      { icon: '💧', title: 'Miljövänlig', sub: 'Vattenbesparande teknik.' },
      { icon: '⭐', title: 'Topprankad', sub: '4,9 stjärnor från våra kunder.' },
      { icon: '💳', title: 'Betala efteråt', sub: 'Kontant eller kort på plats.' },
      { icon: '🕗', title: 'Öppettider', sub: 'Mån–Fre 08:00–18:00 · Lör–Sön 09:00–18:00.' },
    ],

    // CTA banner
    ctaBannerTitle: 'Redo för en ren bil?',
    ctaBannerSub: 'Boka på under 2 minuter.',
    ...
    areaExpandText: 'Vi tillhandahåller för närvarande våra tjänster i dessa områden och närliggande platser. Vi planerar också att expandera till fler städer i framtiden.',
