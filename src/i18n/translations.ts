...
export const translations = {
  en: {
    ...
    cityLabel: "City / area",
    cityError: "Please choose your city.",
    travelFeeLabel: "Travel fee",
    travelFeeNote:
      "A travel fee is added for areas farther from Gävle to cover fuel and driving time.",
    noTravelFee: "No travel fee",
    inclTravelFee: "incl. travel fee",
  ...
  sv: {
    ...
    cityLabel: "Stad / område",
    cityError: "Välj din stad.",
    travelFeeLabel: "Reseavgift",
    travelFeeNote:
      "En reseavgift tillkommer för områden längre bort från Gävle för att täcka bensin och körtid.",
    noTravelFee: "Ingen reseavgift",
    inclTravelFee: "inkl. reseavgift",
